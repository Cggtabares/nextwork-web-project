...
- This project is part of a series to enhance my knowledge on DevOps and how to work with the most important tools in DevOps
...
3. Install dependencies:
    ...
    mvn install
    ```
- Troubleshooting: When Git, asks you for the Credentials to Push the changes to your GitHub account.

> Remember: you have to provide the Authentication token that you already created on the GitHub account.

<br>

## Contact
If you have any questions or comments about the NextWork Web Project, please contact:
Carlos Gonzalez - carlosggtabares@gmail.com(mailto:carlosggtabares@gmail.com)

### Linkedin Profile
[www.linkedin.com/in/carlos-gonzalez-t](www.linkedin.com/in/carlos-gonzalez-t)
